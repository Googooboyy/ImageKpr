    ...
    <form method="post" action="config.php" class="admin-config-form">
      ...
      <section class="admin-collapsible" data-collapsible-key="config_storage_quotas">
        ...
        <div class="admin-collapsible-body admin-config-panel">
          ...
          <p class="admin-muted"><strong>Stripe / SaaS tier matrix</strong> (reference when setting per-user byte caps on <a href="index.php">Users</a>; includes Free, Silver, Gold, and Platinum): <?php echo imagekpr_admin_html_plan_matrix_saas_blurb(); ?></p>
